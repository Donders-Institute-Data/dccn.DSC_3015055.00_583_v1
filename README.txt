...
Johannes Vorwerk, Robert Oostenveld, Maria Carla Piastra, Lilla Magyari, Carsten H. Wolters (2017).
The FieldTrip-SimBio Pipeline for EEG Forward Solutions [Data set].
http://hdl.handle.net/11633/di.dccn.DSC_3015055.00_583.

# Abstract

This dataset includes a MATLAB script and the required data (in *.mat format)  to demonstrate the FieldTrip-SimBio pipeline for EEG forward solutions using the Finite Element Method.

# Background information

You can find more information, including relevant publications pertaining to this dataset on the collection overview page at http://hdl.handle.net/11633/di.dccn.DSC_3015055.00_583.
